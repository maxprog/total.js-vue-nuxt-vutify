...
var MetaRenderer = function () {
  ...
  createClass(MetaRenderer, [{
    ...
    key: 'render',
    value: function () {
      var _ref = asyncToGenerator(index$1.mark(function _callee(_ref2) {
              ...
              case 6:
                ...
                if (this.options.render.resourceHints && clientManifest) {
                  ...
                  if (Array.isArray(clientManifest.initial)) {
                    meta.HEAD += clientManifest.initial.map(function (r) {
                  ...
                  if (Array.isArray(clientManifest.async)) {
                    meta.HEAD += clientManifest.async.map(function (r) {
  ...
  createClass(Renderer, [{
    ...
    value: function errorMiddleware(err, req, res, next) {
      ...
      var sendResponse = function sendResponse(content) {
        ...
        res.statusMessage = _this4.options.debug ? err.message : err.name;
    ...
    key: 'readSource',
    value: function () {
      var _ref8 = asyncToGenerator(index$1.mark(function _callee6(frame) {
    ...
    value: function () {
      var _ref9 = asyncToGenerator(index$1.mark(function _callee7(url) {
        ...
        var spa, _ref10, HTML_ATTRS, BODY_ATTRS, _HEAD, _APP, data, _html, APP, m, HEAD, resourceHints, html;
            ...
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                return _context7.abrupt('return', new Promise(function (resolve$$1) {
                  setTimeout(function () {
                    return resolve$$1(_this5.renderRoute(url, context));
                  }, 1000);
                }));
              ...
              case 9:
                ...
                return _context7.abrupt('return', { html: _html });
    ...
    value: function () {
      var _ref11 = asyncToGenerator(index$1.mark(function _callee8(url) {
